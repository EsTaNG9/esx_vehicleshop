Locales['br'] = {
  ...
  ['license_missing']         = 'você não tem carta de condução!',
  ...
  ['set_vehicle_owner_sell_society']  = 'atribuir veículo [Sale] [Society]',
  ...
  ['testdrive_notification'] = 'Tens ~g~%s~w~ segundos para fazer o teste drive!',
  ['testdrive_timer'] = 'Teste drive acaba em: %s segundos!',
  ['testdrive_menutext'] = 'Fazer um Test Drive primeiro!',
  ['testdrive_finnish'] = 'Acabou o Test Drive',
}
